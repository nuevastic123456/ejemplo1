    ...
    <section class="NavLateral full-width">
        ...
        <div class="NavLateral-content full-width">
            <header class="NavLateral-title full-width center-align">
                <img class="responsive-img" width="200" src="public/img/logo.png">
                ...
                <ul class="full-width">
                    ...
                    <li>
                        ...
                        <ul class="full-width">
                            ...
                            <li class="NavLateralDivider"></li>
                            <li><a href="form.html" class="waves-effect waves-light">Permisos de usuario</a></li>
                        </ul>
                    </li>
                    <li class="NavLateralDivider"></li>
                    <li>
                        ...
                        <ul class="full-width">
                            ...
                            <li class="NavLateralDivider"></li>
                            <li><a href="form.html" class="waves-effect waves-light">Unidades de medida</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="form.html" class="waves-effect waves-light">Categorias</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="form.html" class="waves-effect waves-light">Modo de factura</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="form.html" class="waves-effect waves-light">Modo de compra</a></li>
                        </ul>
                    </li>
                    <li class="NavLateralDivider"></li>
                   <li>
                        ...
                        <ul class="full-width">
                            <li><a href="button.html" class="waves-effect waves-light">Información del negocio</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="form.html" class="waves-effect waves-light">Simbolo de moneda</a></li>
                            <li class="NavLateralDivider"></li>
                            <li><a href="form.html" class="waves-effect waves-light">Crear backup</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#" class="NavLateral-DropDown  waves-effect waves-light"><i class="material-icons">delete</i> Eliminado</a>
                    </li>
                </ul>
            </div>  
        </div>  
    ...
    <section class="ContentPage full-width">
        ...
        <div class="ContentPage-Nav full-width">
            <ul class="full-width">
                ...
                <li><a href="{{url('cerrar_sesion')}}" class="tooltipped waves-effect waves-light btn-ExitSystem" data-position="bottom" data-delay="50" data-tooltip="Cerrar sesión"><i class="zmdi zmdi-power"></i></a></li>
                <li>
