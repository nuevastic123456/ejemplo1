...
@section('titulo_pestania', 'Administrar categorias')

@section('titulo')
@parent

<h3 class="center-align">administrar categorias </h3>
@endsection
@section('contenido')
    ...
    @if(count($categorias)>0)
      ...
      <div class="row">
          <div class="col s12">
                ...
                <div class="col s3">
                <a class="btn-floating btn-large #1565c0 blue darken-3 tooltipped" data-tooltip="Buscar"><i class="material-icons" onclick="filtro_busqueda(url_web+'buscar_categoria/'+$('#filtro').val(),'#resultado')">search</i></a>
                ...
                <a class="btn-floating btn-large #1565c0 blue darken-3 tooltipped" data-tooltip="Agregar" href="{{url('formulario_registro_categoria')}}" id="agregar_categoria"><i class="material-icons">add</i></a>
                </div>
         </div>
      </div>
        ...
        <div class="col s12">
          <div class="card">
            <div class="card-content" id="resultado">
                 @include('paginas.tablas.tabla_categorias')
                {{ $categorias->links() }} 
            </div>
          </div>
        </div>
                  ...
                  @if($permiso==false)
                          <script type="text/javascript">
                             $('#agregar_categoria').addClass('disabled').removeAttr("href");
                          </script>
                  @endif
