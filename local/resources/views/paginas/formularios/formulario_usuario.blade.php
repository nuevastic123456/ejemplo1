                    ...
                    <div class="input-field col s6">
                        <select name="tipo_documento" id="tipo_documento">
                          ...
                          @foreach($tipo_documento as $registro)
                            <option value="{{$registro->id}}">{{$registro->td_descripcion}}</option>
                          @endforeach
                        </select>
                    ...
                    <div class="input-field col s6">
                         <select name="departamento" id="departamento" onchange="cargar_municipios($(this).val())">
                          ...
                          @foreach($departamento as $registro)
                            <option value="{{$registro->id}}">{{$registro->dep_nombre}}</option>
                          @endforeach
                        </select>
                    ...
                    <div class="input-field col s6" id="id_municipio">
                        <select name="municipio" id="municipio">
                          ...
                          @if(isset($consulta_usuario))
                            ...
                            <option value="{{$registro->id}}">{{$registro->mun_nombre}}</option>
                            @endforeach
                          @endif
                        </select>
                    ...
                    <div class="input-field input-group col s6">
                         <select name="tipo_usuario" id="tipo_usuario">
                          ...
                          @foreach($tipo_usuario as $registro)
                            <option value="{{$registro->id}}">{{$registro->tu_descripcion}}</option>
                          @endforeach
                        </select>
...
@if (old('departamento'))
  <script type="text/javascript">
    $("#departamento > option[value="+ <?php echo old('departamento'); ?> +"]").attr('selected',true);
  </script>
@endif
