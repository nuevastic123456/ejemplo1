...
@endsection
@section('contenido')
            <a class="btn-floating btn-large #1565c0 blue darken-3 right tooltipped" href="javascript:window.history.back();" data-tootiped="volver atras"><i class="material-icons">swap_horiz</i></a>
